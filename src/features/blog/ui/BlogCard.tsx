...
export const BlogCard: React.FC<BlogCardProps> = (props) => {
  return (
    <Link
      href={`/blog/${props.id}`}
      className="group relative flex h-full w-full max-w-[400px] flex-col overflow-hidden rounded-lg border border-[#36454F]/40 bg-[#36454F]/20 shadow-lg backdrop-blur-md transition-all duration-300 hover:scale-105 hover:border-[#FFEA00]/20 hover:shadow-xl hover:shadow-[#36454F]/30"
    >
